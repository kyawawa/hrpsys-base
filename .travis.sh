...
case $TEST_PACKAGE in
    ...
    *)
        ...
        ls -al /opt/ros/indigo/share/openhrp3/share/OpenHRP-3.1/sample/controller/SampleController || echo "ok"
        sudo mkdir -p /opt/ros/indigo/share/openhrp3/share/OpenHRP-3.1/sample/controller/SampleController/etc/ || echo "ok"
        sudo wget https://raw.githubusercontent.com/fkanehiro/openhrp3/master/sample/controller/SampleController/etc/Sample.pos -O /opt/ros/indigo/share/openhrp3/share/OpenHRP-3.1/sample/controller/SampleController/etc/Sample.pos || echo "ok"
        sudo wget https://raw.githubusercontent.com/fkanehiro/openhrp3/master/sample/controller/SampleController/etc/Sample.vel -O /opt/ros/indigo/share/openhrp3/share/OpenHRP-3.1/sample/controller/SampleController/etc/Sample.vel || echo "ok"
        travis_time_end
