  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::OutPort<RTC::TimedDoubleSeq> m_qSTRefOut;
 ...
 private:
  ...
  bool is_legged_robot, on_ground, is_emergency, is_seq_interpolating, reset_emergency_flag, eefm_use_force_difference_control, eefm_use_swing_damping, initial_cp_too_large_error, use_limb_stretch_avoidance, use_servo_gain_control;
